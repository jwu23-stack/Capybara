    ...
    <div id="teach-page">
      ...
      <div className="d-flex flex-row justify-content-between" id="teach-container">
        ...
        <div className="d-flex flex-column teach-text">
          ...
          <button type="button" className="btn btn-warning mt-3 px-5 teach-button" onClick={handleClick}>Apply Now</button>
        </div>
      </div>
      ...
      <div className="d-flex flex-column text-center" id="how-it-works">
        ...
        <div className="steps-row">
          ...
          <div className="steps-column">
            <div className="individualSteps-column">
            ...
            <div className="thirdStep-column">
